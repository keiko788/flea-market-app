<x-app-layout>
    ...
    <div class="max-w-[1120px] mx-auto mt-[78px] pl-[103px] flex justify-between items-center">
        ...
        <a href="{{ route('profile.edit', ['redirect_to' => 'mypage']) }}"
            class="flex justify-center items-center w-[310px] h-[59px] border-[#FF5555] rounded-[10px] border-2 text-[26px] text-[#FF5555] font-bold">
            プロフィールを編集
        </a>
    </div>
