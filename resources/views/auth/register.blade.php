    ...
    <div class="max-w-[680px] mx-auto mt-[96px]">
        ...
        <div>
            <form method="POST" action="{{ route('register.store') }}" novalidate>
                ...
                <!-- ユーザー名 -->
                <div>
                    <label for="name" class="block text-2xl font-bold mb-2">
                        ユーザー名
                    </label>
                    <input id="name"
                ...
                <!-- 確認用パスワード -->
                <div class="mt-[38px]">
                    <label for="password_confirmation" class="block text-2xl font-bold mb-2">
                        確認用パスワード
                    </label>
            ...
            <a href="{{ route('login') }}" class="block text-center text-[#0073cc] mb-[43px] cursor-pointer">
                ログインはこちら
            </a>
