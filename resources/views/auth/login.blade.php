    ...
    <div class="max-w-[680px] mx-auto mt-[110px]">
        ...
        <div>
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <button type=" submit" class="w-full text-white font-bold text-[26px] bg-[#FF5555] rounded-[5px] flex items-center justify-center h-[65.25px] mt-20 mb-[18px]">ログインする</button>

            </form>
            <a href="/register" class="block text-center text-[#0073cc]">会員登録はこちら</a>
        </div>
    </div>
</x-auth-layout>